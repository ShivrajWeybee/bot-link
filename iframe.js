...
button.onclick = () => {
    ...
    ssbFrame.style.display = isOpen ? "none" : "block"; isOpen = !isOpen;
}
ssbFrame.src = `http://social.weybee.in:8080`; document.body.append(ssBot); ssBot.append(ssbFrame);