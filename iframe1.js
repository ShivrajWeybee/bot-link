...
ssbFrame.src = `${window.__isp == 1 ? "https://bot.socialsparsh.com/" : "http://bot.socialsparsh.staging.weybee.in/"}${window.__ab.id}`; document.body.append(ssBot); ssBot.append(ssbFrame);