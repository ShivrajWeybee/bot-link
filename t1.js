...
button.onclick = () => {
    ...
    if (!botCall) { ssbFrame.src = `https://socialsparsh.staging.weybee.in/?id=${window.config.id}`; }
    botCall = true;
}
